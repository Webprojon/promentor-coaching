...
const TEXTAREA_BASE_CLASS =
  "w-full rounded-lg border border-white/20 px-3 py-2 text-sm pm-text-primary outline-none transition-all placeholder:pm-text-muted focus:border-[var(--pm-accent-cyan)] focus:ring-2 focus:ring-cyan-500/25 disabled:cursor-not-allowed disabled:opacity-50";
